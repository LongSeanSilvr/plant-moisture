...
print("Initializing Hardware (Deep Sleep Mode)...")
...
# 7. Deep Sleep Protocol
sleep_duration = int(os.getenv("SLEEP_SECONDS", 60))
print(f"Entering deep sleep for {sleep_duration} seconds...")

# Create an alarm that will wake the board up after the specified time
time_alarm = alarm.time.TimeAlarm(seconds=sleep_duration)

# Exit and deep sleep until the alarm goes off
